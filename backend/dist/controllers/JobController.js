...
exports.createJob = (0, asyncHandlers_1.default)(async (req, res) => {
    ...
    if (company.owner_id !== userId) {
        throw new errorMiddlewares_1.AppError('Not authorized to create a job for this company', 403);
    }
...
exports.updateJob = (0, asyncHandlers_1.default)(async (req, res) => {
    ...
    if (job.owner_id !== userId && req.user?.role !== 'admin') {
        throw new errorMiddlewares_1.AppError('Not authorized to update this job', 403);
    }
...
exports.deleteJob = (0, asyncHandlers_1.default)(async (req, res) => {
    ...
    // Check ownership or admin rights
    if (job.owner_id !== userId && req.user?.role !== 'admin') {
        throw new errorMiddlewares_1.AppError('Not authorized to delete this job', 403);
    }
